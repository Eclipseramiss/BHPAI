CXX = g++
CC = gcc
CFLAGS = -Wall -Wextra -O2 -I. -ICore/Decompile -ICore/scanner -ICore/pack -Ifuzzy -I"C:/msys64/mingw64/include"
CXXFLAGS = -std=c++17 -Wall -Wextra -O2 -I. -ICore/Decompile -ICore/scanner -ICore/pack -Ifuzzy -I"C:/msys64/mingw64/include"
